...
Este é um projeto de desafio técnico. Se desejar contribuir ou entender o código, siga os padrões estabelecidos:

### Padrões

1. **Clean Architecture** - Separação em 4 camadas
2. **CQRS com MediatR** - Commands e Queries separados
3. **DDD (Domain-Driven Design)** - Entidades ricas e value objects
...
- **Organização:** Um arquivo por classe
